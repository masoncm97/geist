    ...
    >
      ...
      <div className="max-w-full w-full flex flex-col gap-5 pt-28">
        ...
        <ul className={classNames(textColor, "text-lg", "list-disc", "ml-6", "space-y-2")}>
          ...
          <li><strong className="underline"><a href="https://www.memphiscap.org/" target="_blank" rel="noopener noreferrer">Memphis Community Against Pollution (MCAP)</a></strong>, an environmental justice organization directly fighting the impacts of the Colossus facility.</li>
