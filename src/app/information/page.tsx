  ...
  return (
    ...
    >
      ...
      <div className="max-w-full w-full flex flex-col gap-5 pt-28">
        ...
        <p className={classNames(textColor, "text-lg")}>The rapid proliferation of AI across virtually every consumer and enterprise technology industry has led to increased investments in power-intensive data centers. In some cases, these new data centers have had profoundly negative impacts on the surronding local communities, and the environment at large. I&apos;m hopeful that someday we will understand how to employ AI in a way that does right by the environment and by our most marginalized communities.</p>
